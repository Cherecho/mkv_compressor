...
setup(
    ...
    version="1.2.0",
    author="Alvaro Cerezo Pedrero",
    author_email="alvarocerezo212@gmail.com",
    description="A professional video compression tool for MKV files",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/Cherecho/mkv_compressor",
    project_urls={
        "Bug Reports": "https://github.com/Cherecho/mkv_compressor/issues",
        "Source": "https://github.com/Cherecho/mkv_compressor",
        "Documentation": "https://github.com/Cherecho/mkv_compressor/wiki",
    },
