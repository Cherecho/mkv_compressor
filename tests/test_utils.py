...
class TestHelperFunctions(unittest.TestCase):
    ...
    def test_sanitize_filename(self):
        ...
        self.assertEqual(
            sanitize_filename("file<with>bad:chars.mp4"), "file_with_bad_chars.mp4"
        )
        self.assertEqual(
            sanitize_filename("file/with\\slashes.mp4"), "file_with_slashes.mp4"
        )
        self.assertEqual(
            sanitize_filename("file|with?other*chars.mp4"), "file_with_other_chars.mp4"
        )
    ...
    def test_validate_ffmpeg(self, mock_run):
        ...
        mock_run.return_value = Mock(returncode=0, stdout="ffmpeg version 4.4.0")
